...
| 센서 유형 | 정식 명칭 | 운영 | 서울시 내 센서 수 | 공간 해상도 | 특징 |
|:--------:|:---------|:----:|:--------------:|:----------:|------|
| **S-DoT** | Smart Seoul Data of Things | 서울시 | **1,200+** | **~500m** | IoT 환경 센서, 동 단위 미세 환경 포착 |
| RTD | 실시간 도시데이터 | 서울시 | 120 | ~2km | 인구·교통·환경 융합 데이터 |
| AWS | 자동기상관측 | 기상청 | ~28 | ~10km | 자동 기상 관측 장비 |
| ASOS | 종관기상관측 | 기상청 | 2 | ~100km | 서울·서울기상관측소 |
