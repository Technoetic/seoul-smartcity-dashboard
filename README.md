...
> **S-DoT**(Smart Seoul Data of Things)는 서울시가 자체 설치·운영하는 IoT 환경 센서 네트워크입니다.
> 기상청 ASOS(종관기상관측, ~100km 간격) · AWS(자동기상관측, ~10km 간격)보다 **훨씬 높은 공간 해상도**(~500m 간격)로
> 동 단위 미세 환경 변화를 포착할 수 있습니다. 여기에 RTD(실시간 도시데이터, 서울 주요 120곳의 인구·교통·환경 융합 데이터)를
> 결합하여 도시 환경을 입체적으로 모니터링합니다.
