...
| 센서 유형 | 정식 명칭 | 운영 | 공간 해상도 | 특징 |
|:--------:|:---------|:----:|:----------:|------|
| **S-DoT** | Smart Seoul Data of Things | 서울시 | **~500m** | 1,200+ IoT 센서, 동 단위 미세 환경 포착 |
| RTD | 실시간 도시데이터 | 서울시 | ~2km (120곳) | 인구·교통·환경 융합 데이터 |
| AWS | 자동기상관측 | 기상청 | ~10km | 전국 분포 자동 관측 장비 |
| ASOS | 종관기상관측 | 기상청 | ~100km | 공항 등 주요 거점 관측소 |
